...
```
npm i @ant-tech/react-native-google-places --save
```

OR

```
yarn add @ant-tech/react-native-google-places
```
...
target '_YOUR_PROJECT_TARGET_' do
  ...
  pod 'react-native-google-places', :path => '../node_modules/@ant-tech/react-native-google-places'
...
project(':react-native-google-places').projectDir = new File(rootProject.projectDir, '../node_modules/@ant-tech/react-native-google-places/android')
```
...
dependencies {
    ...
    compile project(':@ant-tech/react-native-google-places')
}
```
...
```javascript
import RNGooglePlaces from "@ant-tech/react-native-google-places";
```
